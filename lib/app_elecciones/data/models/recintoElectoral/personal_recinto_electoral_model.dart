...
PersonalRecintoElectoralModel personalRecintoElectoralModelFromJson(
        String str) =>
    PersonalRecintoElectoralModel.fromJson(json.decode(str));

String personalRecintoElectoralModelToJson(
        PersonalRecintoElectoralModel data) =>
...
class PersonalRecintoElectoralModel {
  ...
  factory PersonalRecintoElectoralModel.fromJson(Map<String, dynamic> json) =>
      PersonalRecintoElectoralModel(
        personalRecintoElectoral: json["datos"] == null
            ? []
            : List<PersonalRecintoElectoral>.from(
                json["datos"].map((x) => PersonalRecintoElectoral.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "personalRecintoElectoral": personalRecintoElectoral == null
            ? null
            : List<dynamic>.from(
                personalRecintoElectoral.map((x) => x.toJson())),
      };
}
