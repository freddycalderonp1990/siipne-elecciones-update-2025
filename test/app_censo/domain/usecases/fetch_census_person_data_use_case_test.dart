...
void main() {
  ...
  late FetchCensusPersonDataUseCase useCase;
  ...
  setUp(() {
    ...
    useCase = FetchCensusPersonDataUseCase(repository: mockRepository);
  });

  group('Use Case Datos Persona Censo - TEST', ()
  {
    ...
    test('retorna lista de DataCensado desde el repositorio', () async {
      ...
      when(() => mockRepository.getDatosPersonaCenso(request: testRequest))
      ...
      verify(() => mockRepository.getDatosPersonaCenso(request: testRequest))
          .called(1);
    });
  });
}
